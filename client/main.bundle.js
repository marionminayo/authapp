...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_10__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_12__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_13__services_socket_service__["a" /* SocketService */]],
...
var DashboardComponent = (function () {
    function DashboardComponent(_socketService) {
...
module.exports = "<div class=\"jumbotron text-centre\">\n  <h1>3Miles BreakDown</h1>\n  <p class=\"lead\">Trusted roadside assistance</p>\n  <div>\n    \n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-6\">\n    <h1>Taking insurance</h1>\n    <p><img src=\"assets/cars.jpg\" alt=\"Responsive image\" class=\" img\"></p>\n  </div>\n  <div class=\"col-md-6\">\n    <h1>a mile further</h1>\n    <p><img src=\"assets/mechanic.jpg\" alt=\"Responsive image\" class=\" img\"></p>\n  </div>\n \n</div>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            if (data.success) {
                ...
                _this.flashMessage.show('You have successfully logged in', {
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this.flashMessage.show('put a valid email', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        //register user
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Registration successful. You can now login', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('An error occurred, please try again', { cssClass: 'alert-danger', timeout: 3000 });
